...
public final class MainPanel extends JPanel {
    ...
    public static void createAndShowGUI() {
        ...
        JFrame frame = new JFrame("DnDLayerTabbedPane");
...
//            JCheckBoxMenuItem check = new JCheckBoxMenuItem("Ghost image: Heavyweight");
//            check.addActionListener(e -> {
//                JCheckBoxMenuItem d = (JCheckBoxMenuItem) e.getSource();
//                handler.setDragImageMode(d.isSelected() ? DragImageMode.Heavyweight : DragImageMode.Lightweight);
//            });
//            
